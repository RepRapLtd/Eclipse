...
*/
    ...
    {
    	String root = "file:///home/ensab/Desktop/rrlOwncloud/RepRapLtd/Engineering/Software/Eclipse/workspace/polyhedra/";
    	String name = "cube-cube";
    	String stl = ".stl";
    	String ply = ".ply";
...
//		Triangulation t = Triangulation.CombineTwoTriangulations(t0, t1);
    	Triangulation t = new Triangulation(root + name + stl, new Color3f(0.0f, 1.0f, 0.0f));
    	t.PrintStatistics();
